...
<head>
    ...
    body {
        ...
        /* THÊM MỚI: Ngăn cuộn ngang khi sidebar ẩn */
        overflow-x: hidden;
    }
    ...
    .sidebar {
        ...
        /* THÊM MỚI: CSS cho hiệu ứng trượt */
        margin-left: 0;
    ...
    .main-wrapper {
        /* ===== THAY ĐỔI QUAN TRỌNG: ĐÃ XÓA "width: 100%;" ===== */
        margin-left: 230px;
        /* width: 100%; <-- Dòng này đã bị xóa để sửa lỗi */
        min-height: 100vh;
        background-color: #f8f9fa;
        transition: margin-left 0.3s ease-in-out;
    }
    ...
    /* ===== THÊM MỚI: CSS CHO TRẠNG THÁI THU GỌN ===== */
    body.sidebar-toggled .sidebar {
        margin-left: -230px;
        /* Ẩn sidebar ra khỏi màn hình */
    }

    body.sidebar-toggled .main-wrapper {
        margin-left: 0;
        /* main-wrapper chiếm toàn bộ không gian */
    }
    ...
    @media (max-width: 768px) {
        ...
        /* ===== THAY ĐỔI: XỬ LÝ TRÊN MOBILE ===== */
        /* Tắt chức năng thu gọn trên mobile (vì nó không cần thiết) */
        body.sidebar-toggled .sidebar {
            margin-left: 0;
        }
        ...
        /* Ẩn nút toggle trên mobile (dùng d-none d-md-inline-block trên nút) */
        /* CSS này để dự phòng */
        #sidebarToggleBtn {
        ...
        <div class="main-wrapper">
            ...
            <div class="topbar">
                ...
                <div class="d-flex align-items-center">
                    <button class="btn btn-light btn-lg me-3 d-none d-md-inline-block" id="sidebarToggleBtn"
                        type="button" title="Thu gọn/Mở rộng">
                        <i class="bi bi-list"></i>
                    </button>
                    <h1 class="topbar-title sparkle-text m-0"> CƠ KHÍ Ý TƯỞNG </h1>
                </div>
